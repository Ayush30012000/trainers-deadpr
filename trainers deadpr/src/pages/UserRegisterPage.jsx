...
const UserRegisterPage = () => {
  ...
  try {
    ...
    if(formData.workoutType) body.append("workoutType",formData.workoutType);
    if(formData?.fitnessGoal) body.append("fitnessGoal",formData?.fitnessGoal);
  ...
  return (
    <>
      <Helmet>
        <title>Register as User - Join FitConnect</title>
        ...
        <meta property="og:title" content="Register as User - Join FitConnect" />
          ...
          >
            <Card className="glass-effect border-white/10">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-3xl font-bold text-white">Register as User</CardTitle>
                <p className="text-white/70 mt-2">
                  Join our community of fitness professionals and start connecting with Trainers
                </p>
              </CardHeader>
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="Fitness Goal" className="text-white">Fitness Goal </Label>
                        <Input
                          id="fitnessGoal"
